...
IPC::Share::BDB::Base - The great new IPC::Share::BDB::Base!
aaaaa
...
Perhaps a little code snippet.
    ...
    use IPC::Share::BDB::Base;

    my $foo = IPC::Share::BDB::Base->new();
    ...
